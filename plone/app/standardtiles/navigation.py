...
class INavigationTile(Schema):
    ...
    root = schema.TextLine(
            ...
            description=_(u'help_navigation_root',
                          default=u"You may search for and choose a folder "
                                   "to act as the root of the navigation "
                                   "tree.  Leave blank to use the Plone "
                                   "site root."),
            required=False)
    ...
    includeTop = schema.Bool(
            ...
            description=_(u"help_include_top_node",
                          default=u"Whether or not to show the top, or "
                                   "'root', node in the navigation tree. This "
                                   "is affected by the 'Start level' "
                                   "setting."),
            default=False,
            required=False)
    ...
    topLevel = schema.Int(
            ...
            description=_(u"help_navigation_start_level",
                default=u"An integer value that specifies the number of "
                         "folder levels below the site root that must be "
                         "exceeded before the navigation tree will display. 0 "
                         "means that the navigation tree should be displayed "
...
class QueryBuilder(object):
    ...
    def __init__(self, context, tile):
        ...
        topLevel = self.tile.data['topLevel'] or \
