...
class DiscussionTileDownload(object):
    """Implementation of the @@download view on the Discussion tile.
    
    This is a view onto the DiscussionTile tile view.
    """
